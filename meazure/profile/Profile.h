...
public:
    ...
    ///
    virtual bool writeBool(const QString& key, bool value) = 0;
    ...
    /// @return true if successful.
    ///
    virtual bool writeInt(const QString& key, int value) = 0;
    ...
    /// @return true if successful.
    ///
    virtual bool writeUInt(const QString& key, unsigned int value) = 0;
    ...
    /// @return true if successful.
    ///
    virtual bool writeDbl(const QString& key, double value) = 0;
    ...
    /// @return true if successful.
    ///
    virtual bool writeStr(const QString& key, const QString& value) = 0;
    ...
    /// @return Integer value for the key or the default value if the key is not found.
    ///
    virtual unsigned int readUInt(const QString& key, int defaultValue) = 0;
