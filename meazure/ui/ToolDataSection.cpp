...
void ToolDataSection::createFields() {
    ...
    auto* x1Edit = new DataField(k_fieldShortWidth, true);

    auto* y1Label = new QLabel(tr("Y1:"));
    auto* y1Edit = new DataField(k_fieldShortWidth, true);
    ...
    auto* x2Edit = new DataField(k_fieldShortWidth, true);

    auto* y2Label = new QLabel(tr("Y2:"));
    auto* y2Edit = new DataField(k_fieldShortWidth, true);
    ...
    auto* xvEdit = new DataField(k_fieldShortWidth, true);

    auto* yvLabel = new QLabel(tr("YV:"));
    auto* yvEdit = new DataField(k_fieldShortWidth, true);
    ...
    auto* wEdit = new DataField(k_fieldShortWidth, false);

    auto* hLabel = new QLabel(tr("H:"));
    auto* hEdit = new DataField(k_fieldShortWidth, false);
    ...
    auto* dEdit = new DataField(k_fieldShortWidth, false);
    ...
    auto* aEdit = new DataField(k_fieldShortWidth, false);
    ...
    auto* asEdit = new DataField(k_fieldLongWidth, false);

    auto* arLabel = new QLabel(tr("Ar:"));
    auto* arEdit = new DataField(k_fieldLongWidth, false);
